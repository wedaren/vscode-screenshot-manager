...
exports.GalleryViewProvider = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const fs = __importStar(require("fs"));
const IMAGE_EXTENSIONS = new Set(['.png', '.jpg', '.jpeg', '.gif', '.webp']);
class GalleryViewProvider {
    constructor(_extensionUri, getSaveDirectory) {
        this._extensionUri = _extensionUri;
        this._getSaveDirectory = getSaveDirectory;
    }
    updateGetSaveDirectory(fn) {
    ...
    resolveWebviewView(webviewView, _context, _token) {
        ...
        webviewView.webview.onDidReceiveMessage(async (message) => {
            switch (message.type) {
                ...
                case 'openPreview': {
                    const panel = vscode.window.createWebviewPanel('screenshotPreview', path.basename(message.filePath), vscode.ViewColumn.One, { enableScripts: true, localResourceRoots: [vscode.Uri.file(this._getSaveDirectory())] });
    ...
    async _saveImage(base64Data, fileName) {
...
(function() {
    ...
    _getPreviewHtml(imageUri, title) {
        const nonce = getNonce();
        return `<!DOCTYPE html>
<html lang="en">
<head>
...
exports.GalleryViewProvider = GalleryViewProvider;
function getNonce() {
    let text = '';
...
//# sourceMappingURL=galleryViewProvider.js.map