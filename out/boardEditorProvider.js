...
exports.BoardEditorProvider = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const fs = __importStar(require("fs"));
class BoardEditorProvider {
    constructor(extensionUri, getSaveDirectory) {
    ...
    open() {
        ...
        this._loadState();
        this._panel = vscode.window.createWebviewPanel('screenshotBoard', 'Investigation Board', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async _saveImageFile(base64Data, fileName) {
        const dir = this._getSaveDirectory();
        try {
...
exports.BoardEditorProvider = BoardEditorProvider;
function getNonce() {
    let text = '';
...
//# sourceMappingURL=boardEditorProvider.js.map